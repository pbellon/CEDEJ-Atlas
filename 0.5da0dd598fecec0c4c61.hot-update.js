...
var TemperatureRow = function TemperatureRow(_ref2) {
  ...
  return React.createElement(
    ...
    visibleAridities.map(function (ar, key) {
      return React.createElement(TemperatureLegendPattern, {
        key: key,
        patterns: patterns,
        aridity: ar,
        temperature: temp
    ...
    visibleAridities.length === 0 && React.createElement(TemperatureLegendPattern, { temperature: temp })
  );
};
;
...
//# sourceMappingURL=0.5da0dd598fecec0c4c61.hot-update.js.map